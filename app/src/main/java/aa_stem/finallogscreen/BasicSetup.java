...
public class BasicSetup extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sharedPreferences.contains(f_medicine_name) && f_medicine_name!="" && f_medicine_name !=null){
            inputmedicineName.setText(sharedPreferences.getString(f_medicine_name,""));
        }
        if (sharedPreferences.contains(f_dosage_amount) && f_dosage_amount != "" && f_dosage_amount !=null){
            inputmedicineName.setText(sharedPreferences.getString(f_dosage_amount,""));
        }
            ...
            public void onClick(View view){
                ...
                alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int which) {
                        ...
                        i.putExtra("startDate",txtStartDate.getText().toString());
